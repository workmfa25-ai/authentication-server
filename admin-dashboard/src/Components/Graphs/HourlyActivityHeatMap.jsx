...
// // //                 type: 'sequential',
// // //                 colors: [
// // //                     '#0a0e1a', // Very dark navy (almost matching background)
// // //                     '#1a2332', // Dark navy
// // //                     '#2d3748', // Medium dark
// // //                     '#4a5568', // Gray
...
// // //                 emptyColor={darkMode ? '#141b2d' : theme.palette.grey[100]}
// // //                 borderColor={darkMode ? '#2d3748' : theme.palette.background.paper}
// // //                 borderWidth={2}
// // //                 borderRadius={4}
// // //                 enableLabels={true}
// // //                 labelTextColor={darkMode ? '#ffffff' : theme.palette.text.primary}
// // //                 cellOpacity={0.85}
// // //                 cellHoverOpacity={1}
// // //                 tooltip={({ cell }) => (
// // //                     <Box sx={{
...
// //                 borderRadius={4}
// //                 enableLabels={true}
// //                 labelTextColor={darkMode ? '#000000' : theme.palette.text.primary} // Fixed: Use black text in dark mode
// //                 cellOpacity={0.85}
// //                 cellHoverOpacity={1}
// //                 tooltip={({ cell }) => (
// //                     <Box sx={{
